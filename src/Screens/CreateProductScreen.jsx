    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmitNewProduct}>
                ...
                <div>
                    <label htmlFor='price'>Ingrese el titulo</label>
                ...
                <div>
                    ...
                    <input type="text" name='description' id='description' placeholder='Ingrese una descripcion'onChange={handleChange}/>
                </div>
                <div>
                    <label htmlFor='category'>Seleccione categoria</label>
                    <input type="text" name='categoy' id='category' placeholder='Ingrese categoria' onChange={handleChange}/>
                </div>
                <div>
